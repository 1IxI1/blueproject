...
export class JettonMinterTests extends JettonMinter {
  ...
  static createExecuteVotingMessage(
    voting_id: bigint,
    ...
    return beginCell()
      .storeUint(Op.minter.execute_vote_result, 32)
  ...
  async sendExecuteVotingMessage(
  ...
  static createConfirmVotingMessage(
    voting_id: bigint,
    voter: Address,
    query_id: bigint = 0n,
  ) {
    return beginCell()
      .storeUint(Op.minter.request_confirm_voting, 32)
      .storeUint(query_id, 64)
      .storeUint(voting_id, 64)
      .storeAddress(voter)
      .endCell();
