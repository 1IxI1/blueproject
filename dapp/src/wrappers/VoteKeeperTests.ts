...
export class VoteKeeperTests extends VoteKeeper {
    ...
    static requestVoteMessage(
        ...
        return beginCell()
            .storeUint(Op.keeper.request_vote, 32)
    ...
    async sendRequestVote(
        ...
        await provider.internal(via, {
            ...
            value,
            body: VoteKeeperTests.requestVoteMessage(voter, expiration_date, weight, vote_for, vote_confirmation),
        });
    }
}
