...
import { assertVoteChain, differentAddress, getRandom, renewExp, getRandomDuration, getRandomExp, getRandomInt, getRandomPayload, getRandomTon, voteCtx, ActiveWallet, ActiveJettonWallet, pickWinnerResult, sortBalanceResult } from "../utils";
...
describe('DAO integrational', () => {
    ...
    it('jetton owner can vote with confirmation', async () => {
        ...
        it('Regular vote won', async () => {
            ...
            expect(votingRes.transactions).toHaveTransaction({ // init voting
                        from: DAO.address,
                        to: voting.address,
                        success: true
            });
        ...
        it('Vote lost', async () => {
            ...
            expect(votingRes.transactions).toHaveTransaction({ //voting init
                        from: DAO.address,
                        to: voting.address,
                        success: true
            });
