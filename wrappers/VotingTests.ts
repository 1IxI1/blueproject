...
export class VotingTests extends Voting {
    ...
    static initVoteMessage(
        ...
        return beginCell()
            .storeUint(Op.voting.init_voting, 32)
    ...
    async sendInitVoteMessage(
        ...
        await provider.internal(via, {
            ...
            value,
            body: VotingTests.initVoteMessage(expiration_date, voting_type, proposal, initiator),
        });
    }

    static submitVotesMessage(
        voter: Address,
        expiration_date: bigint,
        votes: bigint,
        vote_for: boolean,
        ...
        return beginCell()
            .storeUint(Op.voting.submit_votes, 32)
            .storeUint(query_id, 64)
            .storeAddress(voter)
            .storeUint(expiration_date, 48)
            .storeCoins(votes)
